...
class SuperAdminController {
    ...
    public function dashboard() {
        ...
        extract($viewData);
        $this->ensureDirExists(__DIR__ . '/../templates/superadmin/');
    ...
    public function listAllTickets() {
        ...
        extract($viewData);
        $this->ensureDirExists(__DIR__ . '/../templates/superadmin/'); // Ensure this directory exists
    ...
    public function showUserForm(string $formType = 'create', ?int $id = null, array $errors = [], array $formData = []) {
        ...
        $departments = $this->departmentModel->getAll();
        $roles = ['User', 'Branch Admin', 'Super Admin'];
        $branches = $this->ticketModel->getAllBranches();
